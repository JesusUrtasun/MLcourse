...
n_small = np.linspace(n_ggHiggs[0], 1.5, 20)
n_large = np.linspace(2.5, n_ggHiggs[-1], 30)
n = np.concatenate((n_small, n_large), axis = None).reshape(-1, 1)

# Check figure 1 NLO (left)
def plot_figure1_nlo():

        # Plot NLO asymptotics
        plt.figure()
        gs = gridspec.GridSpec(2, 1, height_ratios = [4, 1])
        plt.subplot(gs[0])
        plt.title("Higgs NLO - figure 1")
        plt.plot(n_ggHiggs, nlo_exact, "r", label = "exact")
        plt.plot(n_ggHiggs, nlo_large_n(n_ggHiggs, "soft0"), "r:", label = "soft0")
        plt.plot(n_ggHiggs, nlo_large_n(n_ggHiggs, "soft1"), "b:", label = "soft1")
        plt.plot(n_ggHiggs, nlo_large_n(n_ggHiggs, "soft2"), "g:", label = "soft2")
        plt.xlim((0, 13))
        plt.ylim((0, 35))
        plt.xlabel(r"$N$")
        plt.ylabel(r"$C^{(1)}(N)$")
        ...
        plt.plot(n_ggHiggs, nlo_large_n(n_ggHiggs, "soft0") / nlo_exact, "r:", label = "soft0")
        plt.plot(n_ggHiggs, nlo_large_n(n_ggHiggs, "soft1") / nlo_exact, "b:", label = "soft1")
        plt.plot(n_ggHiggs, nlo_large_n(n_ggHiggs, "soft2") / nlo_exact, "g:", label = "soft2")
        plt.xlim((0, 13))
        plt.ylim((0.75, 1.25))
        plt.xlabel(r"$N$")
        plt.ylabel(r"$C^{(1)}_{asym} / C^{(1)}_{exact}$")
        plt.legend(loc = "upper right")
        plt.show()

# plot_figure1_nlo()

# Check figure 1 NNLO (left)
def plot_figure1_nnlo():

        # Plot NNLO asymptotics
        plt.figure()
        gs = gridspec.GridSpec(2, 1, height_ratios = [4, 1])
        plt.subplot(gs[0])
        plt.title("Higgs NNLO - figure 1")
        plt.plot(n_ggHiggs, nnlo_exact, "r", label = "exact")
        plt.plot(n_ggHiggs, nnlo_large_n(n_ggHiggs, "soft0"), "r:", label = "soft0")
        plt.plot(n_ggHiggs, nnlo_large_n(n_ggHiggs, "soft1"), "b:", label = "soft1")
        plt.plot(n_ggHiggs, nnlo_large_n(n_ggHiggs, "soft2"), "g:", label = "soft2")
        plt.xlim((0, 13))
        plt.ylim((0, 350))
        plt.xlabel(r"$N$")
        plt.ylabel(r"$C^{(2)}(N)$")
        ...
        plt.subplot(gs[1])
        plt.hlines(1, n_ggHiggs[0], n_ggHiggs[-1])
        plt.plot(n_ggHiggs, nnlo_large_n(n_ggHiggs, "soft0") / nnlo_exact, "r:", label = "soft0")
        plt.plot(n_ggHiggs, nnlo_large_n(n_ggHiggs, "soft1") / nnlo_exact, "b:", label = "soft1")
        plt.plot(n_ggHiggs, nnlo_large_n(n_ggHiggs, "soft2") / nnlo_exact, "g:", label = "soft2")
        plt.xlim((0, 13))
        plt.ylim((0.75, 1.25))
        plt.xlabel(r"$N$")
        plt.ylabel(r"$C^{(2)}_{asym} / C^{(2)}_{exact}$")
        plt.legend(loc = "upper right")
        plt.show()
...
def plot_figure1_n3lo():
        ...
        # Plot N3LO asymptotics
        plt.figure()
        gs = gridspec.GridSpec(2, 1, height_ratios = [4, 1])
        plt.subplot(gs[0])
        plt.title("Higgs N3LO - figure 4")
        plt.plot(n_ggHiggs, n3lo_exact, "r", label = "exact")
        plt.plot(n_ggHiggs, n3lo_large_n(n_ggHiggs, "soft0"), "r:", label = "soft0")
        plt.plot(n_ggHiggs, n3lo_large_n(n_ggHiggs, "soft1"), "b:", label = "soft1")
        plt.plot(n_ggHiggs, n3lo_large_n(n_ggHiggs, "soft2"), "g:", label = "soft2")
        plt.xlim((0, 13))
        plt.ylim((0, 5000))
        plt.xlabel(r"$N$")
        plt.ylabel(r"$C^{(3)}(N)$")
        ...
        plt.subplot(gs[1])
        plt.hlines(1, n_ggHiggs[0], n_ggHiggs[-1])
        plt.plot(n_ggHiggs, n3lo_large_n(n_ggHiggs, "soft0") / n3lo_exact, "r:", label = "soft0")
        plt.plot(n_ggHiggs, n3lo_large_n(n_ggHiggs, "soft1") / n3lo_exact, "b:", label = "soft1")
        plt.plot(n_ggHiggs, n3lo_large_n(n_ggHiggs, "soft2") / n3lo_exact, "g:", label = "soft2")
        plt.xlim((0, 13))
        plt.ylim((0.75, 1.25))
        plt.xlabel(r"$N$")
        plt.ylabel(r"$C^{(3)}_{asym} / C^{(3)}_{exact}$")
        plt.legend(loc = "upper right")
        plt.show()
...
def plot_figure2_nlo():
        plt.figure()
        plt.title("Higgs NLO - figure 2")
        plt.plot(n_ggHiggs, nlo_exact, "r", label = "exact")
        plt.plot(n_ggHiggs, nlo_small_n_abf(n_ggHiggs), "r:", label = "ABF (2.53)")
        plt.plot(n_ggHiggs, nlo_small_n_abf_subl(n_ggHiggs), "b:", label = "ABF-subl (2.54)")
...
# Check figure 2 NNLO (left)
def plot_figure2_nnlo():
        plt.figure()
        plt.title("Higgs NNLO - figure 2")
        plt.plot(n_ggHiggs, nnlo_exact, "r", label = "exact")
