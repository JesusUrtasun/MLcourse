...
def plot_figure1_nlo():
        ...
        # plt.savefig("../../../Update_Notes/2020_04_HyperGP_inclusive/plots/data/nlo_large_n.png")
        plt.show()
...
def plot_figure1_nnlo():
        ...
        plt.ylabel(r"$C^{(2)}(N)$")
        plt.legend(loc = "lower right")
        # plt.savefig("../../../Update_Notes/2020_04_HyperGP_inclusive/plots/data/nnlo_large_n.png")
        plt.show()
...
def plot_figure1_n3lo():
        ...
        plt.ylabel(r"$C^{(3)}(N)$")
        plt.legend(loc = "lower right")
        # plt.savefig("../../../Update_Notes/2020_04_HyperGP_inclusive/plots/data/n3lo_large_n.png")
        plt.show()
...
def plot_figure2_nlo():
        ...
        plt.ylabel(r"$C^{(1)}(N)$")
        plt.legend(loc = "upper right")
        # plt.savefig("../../../Update_Notes/2020_04_HyperGP_inclusive/plots/data/nlo_small_n.png")
        plt.show()
...
def plot_figure2_nnlo():
        ...
        plt.ylabel(r"$C^{(2)}(N)$")
        plt.legend(loc = "upper right")
        # plt.savefig("../../../Update_Notes/2020_04_HyperGP_inclusive/plots//data/nnlo_small_n.png")
        plt.show()
...
def plot_figure2_n3lo():
        ...
        plt.ylabel(r"$C^{(3)}(N)$")
        plt.legend(loc = "upper right")
        # plt.savefig("../../../Update_Notes/2020_04_HyperGP_inclusive/plots/data/n3lo_small_n.png")
        plt.show()
...
def plot_figure5():
        ...
        plt.ylabel(r"$C^{(3)}(N)$")
        plt.legend(loc = "upper right")
        # plt.savefig("../../../Update_Notes/2020_04_HyperGP_inclusive/plots/data/all_orders.png")
        plt.show()
